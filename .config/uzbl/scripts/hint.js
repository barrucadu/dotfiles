...
function generateHint(el, label) {
    ...
    hint.style.backgroundColor = '#303030';  // Default: #B9FF00
    hint.style.border = '2px solid #101010'; // Default: 2px solid #4A6600
    hint.style.color = '#d3d3d3';            // Default: black
    hint.style.fontFamily = "Consolas";      // Default: [no entry]
    hint.style.fontSize = '12px';            // Default: 9px
    ...
    hint.style.webkitBorderRadius = '0px';   // Default: 6px
